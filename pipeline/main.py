...
def parse_arguments():
    ...
    parser.add_argument(
        '--historical-tables',
        type=str,
        help='Kommagescheiden lijst van tabellen voor historische data (standaard: Lessen,Omzet,GrootboekRekening,AbonnementStatistieken)',
        default='Lessen,Omzet,GrootboekRekening,AbonnementStatistieken'
    )
